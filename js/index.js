...
function dispaly() {
  ...
  for (var i = 0; i < allData.length; ++i) {
    ...
    <p>${allData[i].link}</p>
    <p><button type="button" onclick="visitUrl(${i})" class="btn btn-outline-success text-center px-4"><i class="fa-regular fa-eye px-1"></i> Vist</button></p>
    <p><button class="btn btn-outline-danger px-3" onclick="delet(${i})" > <i class="fa-solid fa-trash-can px-1"></i>Delete</button></p>
</div>`;
  }
